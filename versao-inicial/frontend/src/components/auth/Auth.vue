    ...
    <div class="auth-modal">
      ...
      <div class="auth-title">{{ showSignup ? 'Register' : 'Login' }}</div>
            ...
            <a href @click.prevent="showSignup = !showSignup">
                ...
                <span v-else>Register here!</span>
            </a>
    </div>
  </div>
</template>
...
.auth-modal {
  background-image: url(https://www.primefaces.org/california/javax.faces.resource/images/special/hollywood-gradient.png.xhtml?ln=california-layout);
